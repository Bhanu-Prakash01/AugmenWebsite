            ...
            <div className="container-fluid brand-bg-black p-0 m-0">
                ...
                <div className="row mx-0 d-flex justify-content-center">
                    <div className="col-7 borderbottom">
                        <h1 className='display-1 fw-bold brand-text-black text-center mb-4' style={{ filter: "blur(4px)" }}>AUGMEN LEARNING'S</h1>
                    </div>
                </div>

                <div className="row mx-0 d-flex justify-content-center my-4  mx-5">
                    ...
                    {STATIC_DATA.COURSE_SECTION.map((item, index) => (
                        <div key={index} className="col-10 d-flex justify-content-between gap-2 mb-4">
                            <div className='col-2 border-green p-4 text-white rounded-4'>
                                <img src={item.image} alt={item.title} width={200} height={150}  style={{ filter: "invert(100%) brightness(200%)" }}  />
                            </div>
                            <div className='col-9'>
                                <h1 className='fw-bold brand-text-green'>{item.title}</h1>
                                <h4 className='text-white mb-4'>{item.description}</h4>
                                <Link to={item.redirect} className="know-more-btn text-decoration-none text-end">{item.buttonText}</Link>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="row mx-0 my-5 d-flex justify-content-center">
                    <div className="col-12 position-relative mb-5" style={{
                        ...
                        <div className="position-absolute top-0 start-25 text-white text-center z-1">
                            <h2 className="fw-bold text-white">Info Page :</h2>
                        </div>

                        <div className="position-absolute translate-middle text-white text-justify z-1"
                            style={{
                                zIndex: 1,
                                top: "90%",
                                left: "50%",
                    ...
                    <h3 className="fw-bold mb-4 text-white ms-5">Subject :</h3>
                    <div className="col-12 d-flex justify-content-center align-items-center gap-4 flex-wrap mt-5">
                        <div className="text-center text-white">
                            <img src={fi_lab1} alt="Robotics Lab Setup" width={250} height={200} className='' />
                            <p className="mt-2 fw-bold">Robotics</p>
                        </div>
                        <div className="text-center text-white">
                            <img src={fi_lab3} alt="Coding and Programming" width={250} height={200} />
                            <p className="mt-2 fw-bold">AR</p>
                        </div>
                        <div className="text-center text-white">
                            <img src={fi_lab4} alt="Hands-on Learning" width={250} height={200} />
                            <p className="mt-2 fw-bold">IOT</p>
                        </div>
                        <div className="text-center text-white">
                            <img src={fi_lab2} alt="Students Working on Robotics" width={250} height={200} />
                            <p className="mt-2 fw-bold">Coding</p>
                        </div>

                        <div className="text-center text-white">
                            <img src={fi_lab5} alt="STEM Education in Action" width={250} height={200} />
                            <p className="mt-2 fw-bold">AI</p>
                        </div>
                    </div>
                ...
                <div className="row mx-0 mt-5 d-flex justify-content-center">
                    ...
                    <div className="col-10 mt-3">
                        <img src={benefits1} alt="" width={1400} height={700} />
                    </div>
                    <div className="col-10">
                        <img src={benefits2} alt="" width={1400} height={700} />
                    </div>
                </div>
